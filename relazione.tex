...
\begin{titlepage}
    ...
    \begin{tabular}{@{}c@{\hspace{0.5cm}}c@{}}
        \raisebox{-.5\height}{\includegraphics[width=4cm]{_assets/logo-universita.png}} & 
...
% Includi l'elicitazione dei requisiti
\section{Elicitazione dei requisiti}
\input{sections/elicitazione}

% Includi i requisiti
\clearpage
\section{Requisiti e vincoli di progetto}
\input{sections/requisiti}

% Includi la categorizzazione di dettaglio
\clearpage
\section{Categorizzazione di dettaglio}

% Includi la priorità dei requisiti
\clearpage
\section{Priorità dei requisiti}
